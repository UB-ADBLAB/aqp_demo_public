...
PostmasterMain(int argc, char *argv[])
{
	...
	/*
	 * Register abtree version store garbage collector.
	 */
	ABTreeRegisterGarbageCollector();
    ABTreeRegisterMetricsReporter();
...
reset_shared(void)
{
    ...
    /*
     * Initialize all the shared data used by ABTree. This must be called
     * before launching any backend.
     */
	EpochSetup();
	ABTreeVersionStoreSetup();
}
