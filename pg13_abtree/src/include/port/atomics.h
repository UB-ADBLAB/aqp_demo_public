...
StaticAssertDecl((SIZEOF_VOID_P == 4 || SIZEOF_VOID_P == 8),
	"pointers must be 32-bit or 64-bit to support atomic ops");

#if SIZEOF_VOID_P == 4
typedef pg_atomic_uint32 pg_atomic_pointer;
#define pg_atomic_read_pointer(ptr) \
	((void*) pg_atomic_read_u32(ptr))
#define pg_atomic_write_pointer(ptr, val) \
	pg_atomic_write_u32(ptr, (uint32)(val))
#define pg_atomic_compare_exchange_pointer(ptr, expected, newval) \
	pg_atomic_compare_exchange_u32((ptr), (uint32 *)(expected), \
								   (uint32)(newval))
#else /* SIZEOF_VOID_P == 8 */
typedef pg_atomic_uint64 pg_atomic_pointer;
#define pg_atomic_read_pointer(ptr) \
	((void*) pg_atomic_read_u64(ptr))
#define pg_atomic_write_pointer(ptr, val) \
	pg_atomic_write_u64(ptr, (uint64)(val))
#define pg_atomic_compare_exchange_pointer(ptr, expected, newval) \
	pg_atomic_compare_exchange_u64((ptr), (uint64 *)(expected), \
								   (uint64)(newval))
#endif
