...
extern Tuplesortstate *tuplesort_begin_index_btree(Relation heapRel,
												   ...
												   int workMem, SortCoordinate coordinate,
												   bool randomAccess);
extern Tuplesortstate *tuplesort_begin_index_abtree(Relation heapRel,
												    Relation indexRel,
												    bool enforceUnique,
												    int workMem, SortCoordinate coordinate,
												    bool randomAccess);
...
#define tuplesort_putindextuplevalues(state, rel, self, values, isnull) \
	tuplesort_putindextuplevalues_with_extra(state, rel, self, values, isnull, \
											 0, 'c')
extern void tuplesort_putindextuplevalues_with_extra(Tuplesortstate *state,
													 Relation rel,
													 ItemPointer self,
													 Datum *values,
													 bool *isnull,
