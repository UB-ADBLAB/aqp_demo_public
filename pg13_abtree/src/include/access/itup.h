...
#define index_form_tuple(tupleDescriptor, values, isnull) \
	index_form_tuple_with_extra(tupleDescriptor, values, isnull, 0, 'm')
extern IndexTuple index_form_tuple_with_extra(TupleDesc tupleDescriptor,
