...
#define  P_IM_MIN       1
#define  P_IM_MAX       10000

/*
    defines which control the item table
*/
#define IT_NUMBER    100000
/*
 * defines which control the stock table
 */
#define ST_SIZE 250
#define ST_QTY_MAX 100
...
#define  C_DISC_MIN    0
#define  C_DISC_MAX    5000
#define  C_GC          "GC"
#define  C_BC          "BC"
#define  C_CRDT_LIM    5000000
#define  C_BANLANCE    -10 
#define  C_PAYMENT_CNT 100
#define  C_YTD_PAYMENT 1000
#define  C_DELIVERY_CNT 0
#define  C_DATA_MIN    300
#define  C_DATA_MAX    500
#define  C_ID_MIN       1
#define  C_ID_MAX       3000
/*
 * defines which control the warehouse table
 */

#define  W_SIZE			125
#define  W_NAME_TAG		"WAREHOUSE#"
#define  W_NAME_FMT		"%%s%%0%d%s"
#define  W_MSEG_MAX		5
#define  W_YTD_MIN      -99999
#define  W_YTD_MAX      100000000
#define  W_YTD          30000000
#define  W_TAX_MIN      0
#define  W_TAX_MAX      2000
...
#define  O_LCNT_MIN      5
#define  O_LCNT_MAX      15
#define  O_ALL_LOCAL      1
/*
    defines which control the orderline
*/
#define OL_QUANTITY 5
#define OL_AMT_MIN 1000
#define OL_AMT_MAX 999999
#define OL_DIST_LEN 24
#define  OL_DELI_D_MIN 0
#define  OL_DELI_D_MAX 9
...
/*
 * defines which control the district table
 */
#define D_SIZE		1000
#define D_NAME_TAG	"District#"
#define D_NAME_FMT	"%%s%%0%d%s"
#define D_MSEG_MAX	5
#define D_TAX_MIN	0
#define	D_TAX_MAX	2000
#define D_YTD       30000.00
#define D_NEXT_O_ID	3001
/*
 * defines which control the history table
 */
#define H_AMOUT     1000
#define H_DATA_MAX	24
#define H_DATA_MIN	12
#define H_DATA_LEN  20
#define H_DATA_SD	23
/*******************************************************************
 *******************************************************************
 ***
...
#define  STARTDATE    122001
//#define  CURRENTDATE  122001
#define  ENDDATE      122426
#define  TOTDATE      425
#define  UPD_PCT      10
#define  MAX_STREAM   60
...
#define PR_MONEY_LAST(f, str) 		dbg_print(DT_MONEY, f, (void *)str, 0, 0)
#define PR_CHR(f, str)	 		dbg_print(DT_CHR, f, (void *)str, 0, 1)
#define PR_FLOAT(f, str)        dbg_print(DT_FLOAT, f, (void *)str, 0, 1)
...
#else
#define  PR_DATE(tgt, yr, mn, dy)	\
sprintf(tgt, "%04d-%02d-%02d", ((int)(yr))+1900, ((int)(mn)), ((int)(dy)))
#endif /* DATE_FORMAT */
...
#define  C_CRDT_SD 49
#define  C_DISC_SD 50
#define  IT_NUMBER_SD 51
#define  OL_AMT_SD 52
#define  OL_DIST_SD 53
#define  P_IM_SD 54
#define  PER_SD  55
#define  OFFSET_SD 56
#define ST_QTY_SD 57
#define ST_DATA_SD 58
#define C_RAND_ID_SD 59
#define  OL_DELIVER_DAY_SD 60
#endif            /* DSS_H */
