...
long
sd_stock(int child, DSS_HUGE skip_count)
{
	return(0L);
}

long
sd_hist(int child, DSS_HUGE skip_count)
{
	return(0L);
}

long
sd_dist(int child, DSS_HUGE skip_count)
{
	return(0L);
}

long
sd_ware(int child, DSS_HUGE skip_count)
{
	return(0L);
}

long
sd_neworder(int child, DSS_HUGE skip_count)
{
	return(0L); 
}
