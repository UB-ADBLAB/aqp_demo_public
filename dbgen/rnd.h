...
{
    {ITEM,   1,          0,	1},					/* P_MFG_SD     0 */
    {ITEM,   46831694,   0, 1},					/* P_BRND_SD    1 */
    {ITEM,   1841581359, 0, 1},					/* P_TYPE_SD    2 */
    {ITEM,   1193163244, 0, 1},					/* P_SIZE_SD    3 */
    {ITEM,   727633698,  0, 1},					/* P_CNTR_SD    4 */
    {NONE,   933588178,  0, 1},					/* text pregeneration  5 */
    {ITEM,   804159733,  0, 2},	/* P_CMNT_SD    6 */
    {PSUPP,  1671059989, 0, SUPP_PER_ITEM},     /* PS_QTY_SD    7 */
    {PSUPP,  1051288424, 0, SUPP_PER_ITEM},     /* PS_SCST_SD   8 */
    {PSUPP,  1961692154, 0, SUPP_PER_ITEM * 2},     /* PS_CMNT_SD   9 */
    ...
    {ORDER_LINE,   209208115,  0, O_LCNT_MAX},        /* L_QTY_SD     14 */
    {ORDER_LINE,   554590007,  0, O_LCNT_MAX},        /* L_DCNT_SD    15 */
    {ORDER_LINE,   72154,  0, O_LCNT_MAX},        /* L_TAX_SD     16 */
    {ORDER_LINE,   1371272478, 0, O_LCNT_MAX},        /* L_SHIP_SD    17 */
    {ORDER_LINE,   675466456,  0, O_LCNT_MAX},        /* L_SMODE_SD   18 */
    {ORDER_LINE,   1808217256, 0, O_LCNT_MAX},      /* L_PKEY_SD    19 */
    {ORDER_LINE,   2095021727, 0, O_LCNT_MAX},      /* L_SKEY_SD    20 */
    {ORDER_LINE,   1769349045, 0, O_LCNT_MAX},      /* L_SDTE_SD    21 */
    {ORDER_LINE,   904914315,  0, O_LCNT_MAX},      /* L_CDTE_SD    22 */
    {ORDER_LINE,   373135028,  0, O_LCNT_MAX},      /* L_RDTE_SD    23 */
    {ORDER_LINE,   717419739,  0, O_LCNT_MAX},      /* L_RFLG_SD    24 */
    {ORDER_LINE,   1095462486, 0, O_LCNT_MAX * 2},   /* L_CMNT_SD    25 */
    ...
    {ITEM,   709314158,  0, 92},      /* P_NAME_SD    37 */
    {ORDER,  591449447,  0, 1},      /* O_PRIO_SD    38 */
    {ORDER_LINE,   431918286,  0, 1},      /* HVAR_SD      39 */
    ...
    {CUST,  844576542,  0, 1},         /*C_CRDT_SD 49*/
    {CUST, 561275453,  0, 1},       /*C_DISC_SD 50*/
    {ORDER_LINE, 653127512, 0, 1},        /*IT_NUMBER_SD 51*/
    {ORDER_LINE, 492354231, 0, 1},      /*OL_AMT_SD 52*/
    {ORDER_LINE, 324254572, 0, 1},      /*OL_DIST_SD 53*/
    {ITEM, 943512523, 0, 1},                /*P_IM_SD 54 */
    {WAREHOUSE, 453541532, 0, 1},
    {NONE, 6945231412, 0, 1},
    {STOCK, 6546539834, 0, 1},
    {STOCK, 1765456324, 0, 1},
    {CUST, 56543574669, 0, 1},
    {NONE, 87654653565, 0, 1},
